    ...
    <footer className="bg-black">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="mb-6 md:mb-0">
                <a href="https://luxxdrip.com" className="flex items-center">
                    <img src={Logo} className="h-20 mr-3" alt="FlowBite Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Luxx Drip Therapy</span>
                </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul className="text-white font-medium">
                        <li className="mb-4">
                            <a href="http://eepurl.com/isMlms" className="hover:underline">Join Our Email List</a>
                        </li>
                        <li>
                            <a href="https://luxxdrip.intakeq.com/booking" className="hover:underline">Book Now</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="text-white font-medium">
                        <li className="mb-4">
                            <a href="https://instagram.com/luxx_drip_therapy" className="hover:underline ">Instagram</a>
                        </li>
                        <li>
                            <a href="https://www.facebook.com/profile.php?id=100089568259975" className="hover:underline">Facebook</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a href="https://instagram.com/luxx_drip_therapy" className="text-gray-600 hover:text-gray-900 dark:hover:text-white">
