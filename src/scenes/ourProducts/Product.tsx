...
const Product = ({ overlay, name, description, image }: Props) => {
    ...
    const overlayStyles = `p-5 absolute z-20 flex h-[420px] w-[300px] flex-col items-center justify-center whitespace-normal bg-secondary-300 text-center text-black opacity-0 transition duration-500 hover:opacity-90`
